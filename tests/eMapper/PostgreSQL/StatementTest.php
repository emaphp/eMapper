 ...
 * @group statement
 */
class StatementTest extends PostgreSQLTest {
	public $statement;
	
	public function __construct() {
		self::setUpBeforeClass();
		$this->statement = new PostgreSQLStatement(self::$conn, new PostgreSQLTypeManager(), null);
	}
	...
	/**
	 * Tests safe string type handler for array values
	 */
