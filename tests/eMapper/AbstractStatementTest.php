...
abstract class AbstractStatementTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCacheKeyInt() {
		$result = $this->statement->format('USER_%{integer}', [25], []);
		$this->assertEquals('USER_25', $result);
	
		$result = $this->statement->format('USER_%{int}', [20], []);
		$this->assertEquals('USER_20', $result);
	
		$result = $this->statement->format('USER_%{i}', [14], []);
		$this->assertEquals('USER_14', $result);
	
		$result = $this->statement->format('USER_%{i}', ['6'], []);
		$this->assertEquals('USER_6', $result);
	
		$result = $this->statement->format('USER_%{i}', [3.65], []);
		$this->assertEquals('USER_3', $result);
	
		$result = $this->statement->format('USER_%{i}', [true], []);
		$this->assertEquals('USER_1', $result);
	
		$result = $this->statement->format('USER_%{i}', [false], []);
	...
	public function testIntArray() {
		$result = $this->statement->format('USER_%{integer}', [[1,2,3]], []);
		$this->assertEquals('USER_1,2,3', $result);
	
		$result = $this->statement->format('USER_%{integer}', [[1, "2", 3.65, true, false]], []);
	...
	public function testFloat() {
		$result = $this->statement->format('PRICE_%{float}', [25], []);
		$this->assertEquals('PRICE_25', $result);
	
		$result = $this->statement->format('PRICE_%{double}', [2.75], []);
		$this->assertEquals('PRICE_2.75', $result);
	
		$result = $this->statement->format('PRICE_%{real}', ['6.75'], []);
		$this->assertEquals('PRICE_6.75', $result);
	
		$result = $this->statement->format('PRICE_%{f}', [true], []);
		$this->assertEquals('PRICE_1', $result);
	
		$result = $this->statement->format('PRICE_%{f}', [false], []);
	...
	public function testFloatArray() {
		$result = $this->statement->format('PRICE_%{float}', [[1.56, 2.21, 3.45]], []);
		$this->assertEquals('PRICE_1.56,2.21,3.45', $result);
	
		$result = $this->statement->format('USER_%{f}', [[1, "2.45", true, false]], []);
	...
	public function testString() {
		$result = $this->statement->format('PROD_%{string}', ['XYZ'], []);
		$this->assertEquals("PROD_'XYZ'", $result);
	
		$result = $this->statement->format('PROD_%{str}', ['ABC'], []);
		$this->assertEquals("PROD_'ABC'", $result);
	
		$result = $this->statement->format('PROD_%{s}', ['QWE'], []);
		$this->assertEquals("PROD_'QWE'", $result);
	
		$result = $this->statement->format('PROD_%{s}', [6], []);
		$this->assertEquals("PROD_'6'", $result);
	
		$result = $this->statement->format('PROD_%{s}', [3.65], []);
		$this->assertEquals("PROD_'3.65'", $result);
	
		$result = $this->statement->format('PROD_%{s}', [true], []);
		$this->assertEquals("PROD_'1'", $result);
	
		$result = $this->statement->format('PROD_%{s}', [false], []);
	...
	public function testStringArray() {
		$result = $this->statement->format('PROD_(%{string})', [['XYZ', 'ABC', 'QWE']], []);
		$this->assertEquals("PROD_('XYZ','ABC','QWE')", $result);
	
		$result = $this->statement->format('PROD_(%{s})', [[1, "QWE", 3.65, false, true]], []);
	...
	public function testSafeString() {
		$result = $this->statement->format('PROD_%{sstring}', ['XYZ'], []);
		$this->assertEquals('PROD_XYZ', $result);
	
		$result = $this->statement->format('PROD_%{sstr}', ['ABC'], []);
		$this->assertEquals('PROD_ABC', $result);
	
		$result = $this->statement->format('PROD_%{ss}', ['QWE'], []);
		$this->assertEquals('PROD_QWE', $result);
	
		$result = $this->statement->format('PROD_%{ss}', [6], []);
		$this->assertEquals('PROD_6', $result);
	
		$result = $this->statement->format('PROD_%{ss}', [3.65], []);
		$this->assertEquals('PROD_3.65', $result);
	
		$result = $this->statement->format('PROD_%{ss}', [true], []);
		$this->assertEquals('PROD_1', $result);
	
		$result = $this->statement->format('PROD_%{ss}', [false], []);
		$this->assertEquals('PROD_', $result);
	}
	...
	public function testSafeStringArray() {
		$result = $this->statement->format('PROD:%{sstring}', [['XYZ', 'ABC', 'QWE']], []);
		$this->assertEquals('PROD:XYZ,ABC,QWE', $result);
	
		$result = $this->statement->format('PROD:%{ss}', [[1, "QWE", 3.65, false, true]], []);
	...
	public function testNull() {
		$result = $this->statement->format('ENT_%{null}', [25], []);
		$this->assertEquals('ENT_NULL', $result);
	
		$result = $this->statement->format('ENT_%{null}', [2.75], []);
		$this->assertEquals('ENT_NULL', $result);
	
		$result = $this->statement->format('ENT_%{null}', ['XYZ'], []);
		$this->assertEquals('ENT_NULL', $result);
	
		$result = $this->statement->format('ENT_%{null}', [true], []);
		$this->assertEquals('ENT_NULL', $result);
	
		$result = $this->statement->format('ENT_%{null}', [false], []);
		$this->assertEquals('ENT_NULL', $result);
	}
	...
	public function testNullArray() {
		$result = $this->statement->format('ENT_%{null}', [[1, 3.45, "XYZ", true, false]], []);
	...
	public function testFailedPropertyReplace1() {
		$result = $this->statement->format('PROD_#{code}', [['xcode' => 'XYZ123']], []);
	}
	...
	public function testFailedPropertyReplace2() {
		$result = $this->statement->format('PROD_#{code}', [NULL], []);
	}
